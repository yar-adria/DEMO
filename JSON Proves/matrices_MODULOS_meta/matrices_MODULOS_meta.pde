...
void setup() {
  ...
  json = loadJSONObject("https://dweet.io/get/latest/dweet/for/1.3.6.1.4.1.43409.1.1024.1");



  JSONArray  val1 =  json.getJSONArray("with");
  JSONObject val2 = json.getJSONObject("thing");
  int valormouse = json.getInt("NumberOfProccesses");
}
